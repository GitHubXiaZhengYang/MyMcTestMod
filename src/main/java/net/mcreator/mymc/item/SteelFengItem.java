...
public class SteelFengItem extends Item {
	public SteelFengItem() {
		super(new Item.Properties().stacksTo(64).fireResistant().rarity(Rarity.COMMON).food((new FoodProperties.Builder()).nutrition(-10).saturationMod(-1f).alwaysEat()
...
//	}
	...
	public void appendHoverText(ItemStack itemstack, Level world, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.literal("\u00A79SteelFeng"));
		list.add(Component.literal("\u00A79Mysterious dust"));
	}
